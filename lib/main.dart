...
import 'package:prosis_mobile/Sayfalar/Kasa/ozetrapor.dart';
import 'package:prosis_mobile/Sayfalar/Kasa/stokdetaylirapor.dart';
...
void main() {
  ...
  runApp(MaterialApp(
    ...
    routes: {
      ...
      "/202001": (context) => PageKasaOzetRapor(),
      "/202002": (context) => PageKasaStokDetayliRapor(),
    },
