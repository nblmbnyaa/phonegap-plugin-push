...
class PageGirisIrsaliyesi extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return PageGirisIrsaliyesiState();
  }
}

class PageGirisIrsaliyesiState extends State<PageGirisIrsaliyesi> {
  ...
  Future onLoad() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(
        parametreler, MyApp.apiUrl + "apigirisirsaliyesi/FormLoad", context);
    if (sn.basarili) {
  ...
  void cariAra(bool kod) async {
    ...
    String url = "";
    if (kod) {
      url = MyApp.apiUrl + "apigirisirsaliyesi/CariKodAra";
      parametreler.add(txtCariKod.text);
    } else {
      url = MyApp.apiUrl + "apigirisirsaliyesi/CariUnvanAra";
  ...
  void cariGetir() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(parametreler,
        MyApp.apiUrl + "apigirisirsaliyesi/CariBilgileri", context);
    if (sn.basarili) {
      var gelen = json.decode(sn.sonuc);
  ...
  void odemePlaniAra() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(parametreler,
        MyApp.apiUrl + "apigirisirsaliyesi/OdemePlaniAra", context);
    if (!sn.basarili) {
      Mesajlar().tamam(
          context,
          Text(
  ...
  void depoAra() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(
        parametreler, MyApp.apiUrl + "apigirisirsaliyesi/DepoAra", context);
    if (!sn.basarili) {
      Mesajlar().tamam(
          context,
          Text(
  ...
  void plasiyerAra() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(
        parametreler, MyApp.apiUrl + "apigirisirsaliyesi/PlasiyerAra", context);
    if (!sn.basarili) {
      Mesajlar().tamam(
          context,
          Text(
  ...
  void projeAra() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(
        parametreler, MyApp.apiUrl + "apigirisirsaliyesi/ProjeAra", context);
    if (!sn.basarili) {
      Mesajlar().tamam(
          context,
          Text(
  ...
  void srmMrkAra() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(
        parametreler, MyApp.apiUrl + "apigirisirsaliyesi/SrmMrkAra", context);
    if (!sn.basarili) {
      Mesajlar().tamam(
          context,
          Text(
  ...
  void stokAra(bool kod) async {
    ...
    String url = "";
    if (kod) {
      url = MyApp.apiUrl + "apigirisirsaliyesi/StokKoduAra";
      parametreler.add(txtStokKodu.text);
    } else {
      url = MyApp.apiUrl + "apigirisirsaliyesi/StokAdiAra";
  ...
  void stokGetir() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(parametreler,
        MyApp.apiUrl + "apigirisirsaliyesi/StokBilgileri", context);
    if (sn.basarili) {
      var gelen = json.decode(sn.sonuc);
  ...
  void ekle() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(
        parametreler, MyApp.apiUrl + "apigirisirsaliyesi/Ekle", context);
    if (sn.basarili) {
      var gelen = json.decode(sn.sonuc);
  ...
  void kaydet() async {
    ...
    DefaultReturn sn = await BasariUtilities().getApiSonuc(
        parametreler, MyApp.apiUrl + "apigirisirsaliyesi/Kaydet", context);
    if (sn.basarili) {
      var gelen = json.decode(sn.sonuc);
      Mesajlar().tamam(
          context,
