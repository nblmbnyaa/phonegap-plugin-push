...
class PageAlinanSiparis extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return PageAlinanSiparisState();
  }
}

class PageAlinanSiparisState extends State<PageAlinanSiparis> {
  ...
  void cariAra(bool kod) async {
    ...
    String url = "";
    if (kod) {
      url = MyApp.apiUrl + "apialinansiparis/CariKodAra";
      parametreler.add(txtCariKod.text);
    } else {
      url = MyApp.apiUrl + "apialinansiparis/CariUnvanAra";
  ...
  void stokAra(bool kod) async {
    ...
    String url = "";
    if (kod) {
      url = MyApp.apiUrl + "apialinansiparis/StokKoduAra";
      parametreler.add(txtStokKodu.text);
    } else {
      url = MyApp.apiUrl + "apialinansiparis/StokAdiAra";
